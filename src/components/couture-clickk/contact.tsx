...
export function Contact() {
  return (
    ...
    >
      ...
      <div className="absolute -top-32 -right-32 w-full h-full sm:w-[600px] sm:h-[600px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-500/10 via-transparent to-transparent rounded-full blur-[100px] animate-orb-move-1" />
      <div className="absolute -bottom-40 -left-40 w-full h-full sm:w-[700px] sm:h-[700px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900/10 via-transparent to-transparent rounded-full blur-[120px] animate-orb-move-2" />
      <div className="absolute top-1/2 left-1/4 w-full h-full sm:w-[400px] sm:h-[400px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-rose-700/15 via-transparent to-transparent rounded-full blur-[90px] animate-orb-move-3" />
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-20">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl leading-tight font-medium text-white mb-4 sm:mb-6">
          ...
          <div className="mt-6 sm:mt-8 h-px w-20 sm:w-24 bg-gradient-to-r from-[#C09A6C] via-[#9B6FD7] to-transparent mx-auto" />
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="grid grid-cols-1 gap-6 sm:gap-8">
              {contactDetails.map((item, index) => (
                <a 
                  ...
                  className="group flex items-start gap-4 sm:gap-6 transition-all duration-300 hover:translate-x-2"
                >
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 flex items-center justify-center rounded-full bg-[#18141c] border border-[#C09A6C]/30 group-hover:border-[#C09A6C] transition-all duration-300">
                    <item.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#C09A6C] group-hover:scale-110 transition-transform" />
                  </div>
                  <div>
                    <div className="font-bold text-lg sm:text-xl text-white font-sora mb-1">{item.title}</div>
                    <div className="text-[#C09A6C] font-sora text-sm sm:text-base group-hover:text-white transition-colors">
                      {item.detail}
                    </div>
                  </div>
                </a>
          ...
          <Card className="p-6 sm:p-10 bg-gradient-to-b from-[#1e102d]/70 to-[#0f081b]/70 border border-[#3A1D6A] shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_48px_rgba(113,0,255,0.3)] backdrop-blur-xl transition-all duration-500 rounded-2xl overflow-hidden flex flex-col justify-between max-h-[500px] min-h-[390px]">
            <h3 className="text-2xl sm:text-3xl font-serif font-semibold mb-6 sm:mb-8 text-center text-white">
            ...
            <form className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="relative">
                  <Input 
                    type="text" 
                    placeholder="Name" 
                    className="bg-[#0F081B]/60 border border-[#3A1D6A] text-white placeholder:text-purple-200/60 focus:ring-2 focus:ring-[#C09A6C]/40 focus:border-[#C09A6C] transition-all h-10 sm:h-11 text-sm sm:text-base"
                  />
              ...
              <div className="relative">
                <Textarea 
                  ...
                  rows={4} 
                  className="bg-[#0F081B]/60 border border-[#3A1D6A] text-white placeholder:text-purple-200/60 focus:ring-2 focus:ring-[#C09A6C]/40 focus:border-[#C09A6C] transition-all text-sm sm:text-base"
                />
                <div className="absolute bottom-2 right-2 text-xs text-purple-200/50">Max. 500 characters</div>
              </div>
              
              <Button
                type="submit"
                size="lg"
                className="h-11 sm:h-12 group relative px-6 sm:px-8 font-bold border-3 border-purple-900/40 text-white bg-gradient-to-r from-[#2d183a]/80 via-[#1a1026]/80 to-[#23143a]/80 hover:bg-gradient-to-r hover:from-amber-900/30 hover:via-purple-900/30 hover:to-rose-900/30 backdrop-blur-xl transition-all duration-500 rounded-2xl shadow-[0_0_40px_5px_rgba(168,85,247,0.18)] hover:shadow-[0_0_60px_10px_rgba(168,85,247,0.25)] overflow-hidden w-full"
              >
                {/* Shimmer Effect */}
